...
$workspace-button-background-primary: #046a8a;
$workspace-button-background-primary-hover: #023140;
...
$node-icon-background-color-opacity: 0; //0.05;
...
$node-selected-color: #046a8a;
$port-selected-color: #046a8a;

$link-color: #999;
$link-link-color: #aaa;
$link-disabled-color: #ccc;
$link-link-active-color: #046a8a;
$link-unknown-color: #f00;

$clipboard-textarea-background: #F3E7E7;


$deploy-button-color: rgb(255, 254, 254);
$deploy-button-color-active: rgb(245, 245, 245);
$deploy-button-color-disabled: rgb(14, 13, 13);
$deploy-button-background: #06a5d4;
$deploy-button-background-hover: #0591bc;
$deploy-button-background-active: #046b8a;
$deploy-button-background-disabled: rgb(187, 187, 187);
$deploy-button-background-disabled-hover: #555;


$header-background: rgb(18, 93, 122);
