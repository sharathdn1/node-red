    ...
    function createIconAttributes(iconUrl, icon_group, d) {
        ...
        if (fontAwesomeUnicode) {
            ...
            var icon = icon_group.append("image")
                ...
                .attr("x",("right" == d._def.align ? 0 : 10))
                .attr("width","25")
                .attr("height","30");
        ...
        if (showAllLinkPorts !== -1 || mouse_mode != RED.state.JOINING) {
            ...
            nodeEnter.each(function(d,i) {
                ...
                if (d._def.icon) {
                    ...
                    icon_shade.setAttribute("width",35);
                    ...
                    icon_shade_border.setAttribute("d","right" != d._def.align ? "M 40 1 l 0 "+(d.h-2) : "M 0 1 l 0 "+(d.h-2)  )
                ...
                if (d.dirty) {
                    ...
                    if (d.resize) {
                        ...
                        if (hideLabel) {
                            ...
                            d.w = Math.max(node_width,20*(Math.ceil((labelParts.width+40+(d._def.inputs>0?7:0))/20)) );
                        }
                        if (ow !== undefined) {
                            d.x += (d.w-ow)/2;
                        }
